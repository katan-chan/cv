...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/optical_flow_visualization.png}
    \caption{Minh họa các vector dòng chảy quang học (optical flow vectors) được trích xuất từ các landmark của bàn tay. Các mũi tên biểu diễn hướng và độ lớn của chuyển động của từng landmark giữa hai khung hình liên tiếp.}
    \label{fig:optical_flow_visualization}
\end{figure}
