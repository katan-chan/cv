...
Mô hình bàn tay được biểu diễn dưới dạng hệ xương phân cấp,
trong đó mỗi khớp được mô tả bởi ba thành phần:
...
và 24 khớp còn lại thuộc năm ngón tay, trong đó mỗi ngón tay bao chia đều cho 5 ngón tay, riêng ngón cái chỉ có 4 khớp.

\begin{figure}
    \centering
    \includegraphics[width=0.3\textwidth]{figures/hand_skeleton.png}
